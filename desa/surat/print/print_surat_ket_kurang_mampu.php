...
<tr><td>Keterangan </td><td>:</td><td>Bahwa orang tersebut adalah benar-benar warga kami yang bertempat tinggal di Dusun <?php echo unpenetration(ununderscore($data['dusun']))?> , Desa <?php echo unpenetration($desa['nama_desa'])?>, Kec. <?php echo unpenetration($desa['nama_kecamatan'])?>, Kab. <?php echo unpenetration($desa['nama_kabupaten'])?> tercatat dalam No. KK: <?php echo $data['no_kk']?> dengan NIK: <?php echo $data['nik']?>, Sebagai kepala keluarga : <?php echo unpenetration($data['kepala_kk'])?> diterangkan bahwa menurut sepengetahuan kami ianya termasuk keluarga yang perekonomiannya Kurang Mampu di Desa Kota Pari.</td></tr>
<tr></tr>
<tr></tr>
<tr></tr>
<tr></tr>
