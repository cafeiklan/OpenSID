...
Kabupaten <?php echo unpenetration($desa['nama_kabupaten'])?>, Provinsi <?php echo unpenetration($desa['nama_propinsi'])?> dengan ini menerangkan :</td></tr>
</table>
<div id="isi3">
<table width="100%">
...
<p>Selanjunya Surat Keterangan ini dikeluarkan guna untuk <?php echo $input['keperluan']?></p>
<br>
<p style="padding-left: 30px;">Demikian Surat Keterangan ini diperbuat dengan sebenarnya untuk dapat dipergunakan sebagai</p>
mana mestinya.
<table width="100%">
<tr></tr>
<tr></tr>
