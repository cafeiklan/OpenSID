...
<td><b>Yang bertanda tangan di bawah ini menerangkan dengan sesungguhnya bahwa :</b></td></tr>
 ...
 <div id="isi2">
<table width="100%">
<tr><td width="5%" align="right">I.&nbsp;&nbsp;</td><td width="25%">1. Nama lengkap dan alias</td><td width="3%">:</td><td width="64%"><?php echo unpenetration($input['nama_ayah']); ?></td></tr>
...
<tr><td></td><td>6. Tempat tinggal</td><td>:</td><td><?php echo $input['tempat_tinggal_ayah']; ?></td></tr>
				...
				<tr>&nbsp;</tr>
				<tr>&nbsp;</tr>
<tr><td width="5%" align="right">II.&nbsp;&nbsp;</td><td width="25%">1. Nama lengkap dan alias</td><td width="3%">:</td><td width="64%"><?php echo unpenetration($input['nama_ibu']); ?></td></tr>
...
<tr></tr>
<tr>
<td><b>adalah benar Ayah dan Ibu kandung dari seorang :</b></td>
</tr>
   <tr></tr>
</table>
<table width="100%">
<tr><td width="5%" align="right">&nbsp;&nbsp;</td><td width="25%">1. Nama lengkap dan alias</td><td width="3%">:</td><td width="64%"><?php echo unpenetration($pribadi['nama']); ?></td></tr>
