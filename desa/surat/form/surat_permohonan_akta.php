...
<tr>
  <th>Nomor Surat</th>
  <td><input name="nomor" type="text" class="inputbox required" size="20"/> <span>Terakhir: <?php echo $surat_terakhir['no_surat'];?> (tgl: <?php echo $surat_terakhir['tanggal']?>)</span></td>
</tr>
<tr>
  <th>Nama Anak</th>
...
<tr>
  ...
  <td><input name="tempatlahir_anak" type="text" class="inputbox required" size="35"/>
...
<tr>
  ...
  <td><input name="no_akta_nikah" type="text" class="inputbox required" size="40"/></td>
</tr>
<tr>
    <th>Tanggal Dikeluarkan / Dikeluarkan Oleh :</th>
    <td><input name="tanggal_keluar" type="text" class="inputbox required datepicker" size="10"/>  /  
    <input name="oleh_kua" type="text" class="inputbox required" size="25"/>
