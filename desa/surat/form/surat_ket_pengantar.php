				...
				<div id="form-melengkapi-data-permohonan">
					...
					<table class="form">
						...
						<tr>
							...
							<td width="60%"><input name="nomor" type="text" class="inputbox required" size="20"/> <span>Terakhir: <?php echo $surat_terakhir['no_surat'];?> (tgl: <?php echo $surat_terakhir['tanggal']?>)</span></td>
						</tr>
						<tr>
							<th>Keperluan</th>
